...
//    ImageButton buttonLightSensor;
    ...
    private static final String FB_PROJECT_ID = "firesmartlamp"; //TODO: CHANGE THIS!!!!

    private static final String FB_URL = "https://" + FB_PROJECT_ID + ".firebaseio.com";
    private static final String FB_PATH = "devices";
    private static final String DEVICE_ID = "smartlamp";
...
//        sbDimLevel.setOnSeekBarChangeListener(new DimLevelSeekBarListener());
        ...
        Drawable lampDrawable2 = getResources().getDrawable(R.drawable.ic_incandescent_off);
        button2.setCompoundDrawablePadding(20);
        button2.setCompoundDrawablesWithIntrinsicBounds(null, lampDrawable2, null, null);
...
//    }
    ...
    public void toggleLamp2(final Button button) {

        //4. Button toggle
        button.setEnabled(false);

        mCurrentLamp.parameters.state2 = !mCurrentLamp.parameters.state2;
    ...
    private void updateUIBasedOnLampParameters(HomeXLampParameter lampParams) {
        ...
        button2.setSelected(lampParams.state2);
        button2.setText((lampParams.state2) ? "ON" : "OFF");
        ...
        Drawable lampDrawable2 = getResources().getDrawable(button2.isSelected()? R.drawable.ic_incandescent_on: R.drawable.ic_incandescent_off);
        button2.setCompoundDrawablesWithIntrinsicBounds(null, lampDrawable2, null, null);
